@APIUS015 @API
Feature: APIUS015 As an administrator, I want to be able to access customer addresses registered in the system, add new addresses and update existing addresses via API connection.
